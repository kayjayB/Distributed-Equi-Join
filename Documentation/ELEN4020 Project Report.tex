...
The Message-Passing Interface (MPI) is a library specification for message passing in parallel and distributed environments \cite{comparingMPIMapReduce}. It is widely used in high-performance computing systems \cite{equijoinWithMPI}. The MPI library offers point-to-point communications, broadcast messages and parallel IO \cite{comparingMPIMapReduce}.
