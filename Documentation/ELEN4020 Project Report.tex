...
\tabref{tab:results1} provides the results of the Hybrid solution benchmarks using a the range of file sizes over a changing number of nodes. \tabref{tab:mapreduceresults} provides the results of the benchmarks of the MapReduce solution using the range of file sizes over changing numbers of threads.
